      ...
      <div className="donateStuff-container">
        ...
        >
          ...
          <p className="donateStuff-summaryIconParagraph">
            <img src={shirtIcon} alt="koszulka" />
            <span>
              {fields.numberOfBags +
                " (" +
                fields.itemsToDonate.map((item, i) =>
                  i > 0 ? " " + item : item
                ) +
                ") " +
                fields.beneficiaries.map((beneficiary, i) =>
                  i > 0 ? " " + beneficiary : beneficiary
                )}
            </span>
          </p>
          <p className="donateStuff-summaryIconParagraph">
            <img src={recycleIcon} alt="symbol recyclingu" />
            <span>dla lokalizacji: {fields.location}</span>
          </p>
          <div className="donateStuff-formColumns donateStuff-summaryColumns">
            <div className="donateStuff-formColumn">
              ...
              <div className="donateStuff-formColumnField">
                <p>Kod pocztowy </p>
                <p className="donateStuff-formColumnData">
                  {fields.postalCode}
                </p>
              </div>
              <div className="donateStuff-formColumnField">
            ...
            <div className="donateStuff-formColumn">
              ...
              <div className="donateStuff-formColumnField">
                ...
                <p className="donateStuff-formColumnData donateStuff-formColumnMessage">
                  {fields.message}
                </p>
              </div>
            </div>
          ...
          <div className="donateStuff-buttonWrapper">
            ...
            <button className="donateStuff-button" onClick={handleSubmit}>
              {" "}
              Zatwierdź{" "}
            </button>
          </div>
