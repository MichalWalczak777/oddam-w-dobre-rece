...
const HomeMainButtons = () => {
    ...
    return(
        <div className="homeMain-buttonsBox">
            <button className="general-button homeMain-button"><Link to={"/donateStuff"}>Oddaj rzeczy</Link></button>
            <button className="general-button homeMain-button"><Link to={"/donateStuff"}>Zorganizuj zbiórkę</Link></button>
        </div> 
    )
}   
    ...
    return (
        <div className="homeMain" id="start">
            ...
            <div className="homeMain-mobile">
                ...
                <h2 className="homeMain-lowerHeader"> Oddaj niechciane rzeczy w zaufane ręce</h2> 
                <img className="homeMain-decoration" alt="decoration" src={decoration}></img>
                <HomeMainButtons/>
            </div>
        </div>
